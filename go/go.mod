...
require (
	github.com/RedisHouse/RedisHouse/go-plugins/redis-plugin v0.0.1
...
replace github.com/RedisHouse/RedisHouse/go-plugins/redis-plugin => ./../go-plugins/redis-plugin
