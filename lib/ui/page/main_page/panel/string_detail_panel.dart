...
class StringDetailPanel extends StatefulWidget {
  final StringKeyDetail keyDetail;
  StringDetailPanel(this.keyDetail):super(key: ValueKey(keyDetail.key));
  @override
...
class _StringDetailPanelState extends State<StringDetailPanel> {
  ...
  void initState() {
    ...
    _valueEditingController = TextEditingController(text: widget.keyDetail.value);
  }
